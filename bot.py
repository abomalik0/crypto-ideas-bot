...
✔ تراجع أرصدة المنصّات
→ تقليل المعروض القابل للبيع.

✔ الحيتان فى وضع “Hold / Accumulate”
→ لا توجد موجات بيع مؤسسية حادة.

✔ Hashrate عند قمّة مرتفعة
→ يدعم قوة الشبكة على المدى الطويل.

✔ NUPL
فى منطقة آمنة — بعيد عن الإنهاك أو الفقاعة.
...
- الشراء المؤسسى يظهر غالبًا عند الهبوط:
  → سلوك شراء منظّم أكثر من كونه مضاربيًا.
...
""".strip()
    ...
    # ✅ ضغط ذكى للمسافات فقط لو الرسالة قربت من الحد
